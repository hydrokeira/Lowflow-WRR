...
output<-read.csv("CCContCa.csv")
output<-output[c(2, 3, 6, 9, 16)]
...
#write.csv(output1, "CoalCreekBaseflow.csv")
...
ggplot()+geom_line(output1, mapping=aes(CDate, QBFROminBFmax, color=waterYear))+
  ...
  scale_x_date(date_labels = "%b %d")+ggtitle("QBFROminBFmax")+ylim(0, 7)

ggplot()+geom_line(output1, mapping=aes(CDate, QBFROminBF99, color=waterYear))+
  geom_line(wateryearAGG, mapping = aes(CDate, Q))+
  scale_x_date(date_labels = "%b %d")+ggtitle("QBFROminBF99")+ylim(0, 7)

ggplot()+geom_line(output1, mapping=aes(CDate, QBFRO01BFmax, color=waterYear))+
  geom_line(wateryearAGG, mapping = aes(CDate, Q))+
  scale_x_date(date_labels = "%b %d")+ggtitle("QBFRO01BFmax")+ylim(0, 7)

ggplot()+geom_line(output1, mapping=aes(CDate, QBFRO01BF99, color=waterYear))+
  geom_line(wateryearAGG, mapping = aes(CDate, Q))+
  scale_x_date(date_labels = "%b %d")+ggtitle("QBFRO01BF99")+ylim(0, 7)
...
pdf("CoalCreek_C_Q_CA_EndMemberAnalysis.pdf")
